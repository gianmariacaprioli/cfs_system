...
#######################################################
    ...
    def _cmd_velocity_world_changed(self, msg, uri=""):
        """
        Topic update callback to control the velocity in world frame
        """
        vx = msg.vel.x
        vy = msg.vel.y
        vz = msg.vel.z
        yawrate = degrees(msg.yaw_rate) # Converti radianti -> gradi per cflib
        
        # Invia il comando al drone tramite cflib

...
tmux send-keys -t $P_ALTO_DX "sleep 5 && export PYTHONPATH=/root/CrazySim/crazyflie-lib-python:\$PYTHONPATH && ros2 launch crazyflie_examples StartSystem_sitl.py backend:=cflib" C-m
